...
class UDPServer {
 public:
   ...
   */
  Response createResponse(int clientId, std::string const& command, std::string const& statusMessage,
   ...
   */
  void sendResponseAndLog(TimedMessage timedMessage, Response const& response);
