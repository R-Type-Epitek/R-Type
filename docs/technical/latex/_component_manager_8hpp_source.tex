...
\DoxyCodeLine{00085\ \ \ \ \ \}}
\DoxyCodeLine{00086\ }
\DoxyCodeLine{00090\ \ \ \ \ std::unordered\_map<char\ const*,\ std::shared\_ptr<IComponentArray>>\ \mbox{\hyperlink{class_game_engine_1_1_e_c_s_1_1_component_manager_ae3a5827a5c28371ee5cfe58938fc1b34}{getComponentsWithEntity}}(Entity\ entity)}
\DoxyCodeLine{00091\ \ \ \ \ \{}
\DoxyCodeLine{00092\ \ \ \ \ \ \ std::unordered\_map<char\ const*,\ std::shared\_ptr<IComponentArray>>\ components;}
\DoxyCodeLine{00093\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ \textcolor{keyword}{const}\&\ pair\ :\ m\_componentArrays)\ \{}
\DoxyCodeLine{00094\ \ \ \ \ \ \ \ \ \textcolor{keyword}{auto}\ \textcolor{keyword}{const}\&\ component\ =\ pair.second;}
\DoxyCodeLine{00095\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (component-\/>hasEntity(entity))\ \{}
\DoxyCodeLine{00096\ \ \ \ \ \ \ \ \ \ \ components.insert(\{pair.first,\ component\});}
\DoxyCodeLine{00097\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00098\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00099\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ components;}
\DoxyCodeLine{00100\ \ \ \ \ \}}
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00102\ \ \ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00103\ \ \ \ \ std::unordered\_map<char\ const*,\ ComponentType>\ m\_componentTypes\ \{\};}
\DoxyCodeLine{00104\ }
\DoxyCodeLine{00105\ \ \ \ \ std::unordered\_map<char\ const*,\ std::shared\_ptr<IComponentArray>>\ m\_componentArrays\ \{\};}
\DoxyCodeLine{00106\ }
\DoxyCodeLine{00107\ \ \ \ \ ComponentType\ m\_nextComponentType\ \{\};}
\DoxyCodeLine{00108\ }
\DoxyCodeLine{00109\ \ \ \ \ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00110\ \ \ \ \ std::shared\_ptr<ComponentArray<T>>\ getComponentArray()}
\DoxyCodeLine{00111\ \ \ \ \ \{}
\DoxyCodeLine{00112\ \ \ \ \ \ \ \textcolor{keywordtype}{char}\ \textcolor{keyword}{const}*\ typeName\ =\ \textcolor{keyword}{typeid}(T).name();}
\DoxyCodeLine{00113\ }
\DoxyCodeLine{00114\ \ \ \ \ \ \ assert(}
\DoxyCodeLine{00115\ \ \ \ \ \ \ \ \ m\_componentTypes.find(typeName)\ !=\ m\_componentTypes.end()\ \&\&}
\DoxyCodeLine{00116\ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}ComponentRType\ not\ registered\ before\ use."{}});}
\DoxyCodeLine{00117\ }
\DoxyCodeLine{00118\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ std::static\_pointer\_cast<ComponentArray<T>>(m\_componentArrays[typeName]);}
\DoxyCodeLine{00119\ \ \ \ \ \}}
\DoxyCodeLine{00120\ \ \ \};}
\DoxyCodeLine{00121\ \};\ \textcolor{comment}{//\ namespace\ GameEngine::ECS}}
