 ...
 * @brief Structure representing the header of a network response sent by the
 * server.
 *
 * This structure contains the client identifier, command, the length of the
 * data, the status code and the statusMessage that follows in the message.
 */
struct ResponseHeader {
 ...
 *
 * This structure combines the ResponseHeader with the actual data payload,
 * allowing for easy manipulation and transmission of network responses.
 */
struct Response {
  MessageType const type = MessageType::Response; ///< Type of the message.
