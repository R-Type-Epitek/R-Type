...
class SystemManager {
 public:
  ...
  std::shared_ptr<System> getSystem(char const* name) { return m_systems[name]; }

  std::unordered_map<char const*, std::shared_ptr<System>> getSystems() { return m_systems; }

  Signature getSignature(char const* name) { return m_signatures[name]; }

  std::unordered_map<char const*, Signature> getSignatures() { return m_signatures; }
