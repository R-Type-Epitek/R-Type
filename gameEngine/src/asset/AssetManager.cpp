...
void AssetManager::loadTexturesFormDirectories(std::string const& directory, std::string const& fileExtension) {
...
void AssetManager::unloadTexture(std::string const& textureId) { m_textures.erase(textureId); }
